...
$$c_2' \sim Unif\{447, 894\}$$

$$c_3' \sim Unif\{895, 1341\}$$
...
hist(output$change_point_trace1[output$change_point_trace1 != -1], xlab = "Time (index within time series data)", main = "Change Point 1 trace plot")
hist(output$change_point_trace2[output$change_point_trace2 != -1], xlab = "Time (index within time series data)", main = "Change Point 2 trace plot")
hist(output$change_point_trace3[output$change_point_trace3 != -1], xlab = "Time (index within time series data)", main = "Change Point 3 trace plot")
hist(output$change_point_trace4[output$change_point_trace4 != -1], xlab = "Time (index within time series data)", main = "Change Point 4 trace plot")
```
...
plot_traces_and_hist = function(item, item_name) {
  ...
  xhist <- hist(output_2, plot = FALSE)
