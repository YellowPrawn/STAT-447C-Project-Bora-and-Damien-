...
hist(output$change_point_trace2[output$change_point_trace2 != -1], xlab = "Time (index within time series data)", main = "Change Point 1 trace plot")
hist(output$change_point_trace3[output$change_point_trace3 != -1], xlab = "Time (index within time series data)", main = "Change Point 1 trace plot")
hist(output$change_point_trace4[output$change_point_trace4 != -1], xlab = "Time (index within time series data)", main = "Change Point 1 trace plot")
```
